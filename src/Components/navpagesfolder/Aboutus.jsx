...
const Aboutus = () => {
  return (
    <div className="bg-whiteh">
      ...
      <div   style={{ fontFamily: 'Century Gothic', }} className='font-Poppins mt-10'>
    <div id="PASSION AT WORK" className=''>
        ...
        <div className=''>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHzopYDgRFkbjJWkfMu5DFb7LdJoKA3CrOokdQj2ef5YCITK-DEErPwloYCRDBbfRMb28&usqp=CAU" className='' />
        </div>
        <div>
        <h1 className='lg:text-5xl text-3xl font-medium lg:text-start text-center lg:mt-0 md:mt-0 mt-6 text-[#E79F30]'>Passion at work</h1>
        <div className="max-h-48 overflow-y-auto mt-8">
      <p className='lg:w-[628px] w-80 text-justify sm:w-96 text-xl mt-5 lg:mt-8 font-light'>Passion in accounting fuels precision, diligence, and innovation, transcending numbers into narratives of success. It's the relentless pursuit of accuracy, ensuring each digit aligns with integrity and transparency. Beyond balance sheets, passion ignites curiosity, prompting accountants to unravel financial puzzles and offer strategic insights. It's the drive to not just meet standards but exceed them, turning mundane tasks into opportunities for excellence. Passion in accounting fosters collaboration, as professionals unite to tackle challenges and achieve common goals. It's the commitment to lifelong learning, adapting to evolving regulations and technologies with enthusiasm. This fervor for the craft transforms routine tasks into fulfilling endeavors, where each calculation tells a story of dedication and expertise. Ultimately, passion in accounting isn't just about numbers—it's about making a meaningful impact, empowering businesses to thrive and flourish in an ever-changing financial landscape.</p>
    </div>
        </div>
    ...
    <div className='flex justify-evenly flex-col lg:flex-row md:flex-row items-center lg:mt-28 mt-16'>
        <div>
        <h1 className='lg:text-5xl text-3xl font-medium lg:text-start text-center text-[#E79F30]'>The ShareTax</h1>
      <p className='lg:w-[628px] text-justify w-80 sm:w-96 text-xl mt-5 font-light'>
Taxation, a cornerstone of fiscal policy, funds public services, infrastructure, and social welfare. It serves as a mechanism for wealth redistribution, economic regulation, and incentivizing behavior. Understanding tax codes, deductions, and credits is crucial for individuals and businesses to optimize financial planning and compliance. Taxation impacts investment decisions, consumer behavior, and overall economic activity, influencing market dynamics and wealth distribution. Effective tax management involves strategic planning, risk assessment, and compliance to minimize liabilities and maximize benefits. Tax policies evolve in response to socio-economic trends, technological advancements, and political priorities, shaping the fiscal landscape and influencing economic growth and societal well-being.
</p>
   
        </div>

        <div className='lg:mt-0 md:mt-0 mt-5'>
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqoiOPr8zNCNG_-n5XdMron9rhDbolkb1KnKesk4frEengxFNjjWelcGFnkJFgYUhqznU&usqp=CAU" className='' />
        </div>
