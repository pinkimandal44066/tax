...
<div className="flex mt-7 lg:text-5xl text-2xl text-[#E79F30] cursor-pointer gap-8 justify-center lg:justify-start">
    <Link to="https://www.facebook.com/YourFacebookPage" target="_blank" rel="noopener noreferrer">
        <FaFacebook />
    </Link>

    <Link to="https://www.instagram.com/YourInstagramUsername" target="_blank" rel="noopener noreferrer">
        <FaInstagramSquare />
    </Link>
    ...
    <Link to="https://www.youtube.com/channel/YourChannelID" target="_blank" rel="noopener noreferrer">
      ...
      <div className="">
        <div className="flex flex-col lg:flex-row justify-evenly items-center lg:mx-20 mx-5 ">
          <div className="">
            <h1 className="lg:text-5xl text-3xl font-semibold text-[#E79F30]">
              Reach out to us
            </h1>
        ...
        <div className="flex flex-col lg:flex-row justify-evenly items-center lg:mx-20 mx-5 lg:mt-20 mt-10 ">
          <div className="border-2 border-[#E79F30] overflow-hidden rounded-lg" >
            <img
              ...
              // src="https://www.google.com/maps?sca_esv=64bfd657b885de45&rlz=1C1CHBD_enIN1085IN1086&output=search&q=location+delhi&source=lnms&entry=mc&ved=1t:200715&ictx=111"
...
<div className="flex mt-5">
  ...
  <Link to="tel:+918918304906" className="lg:text-2xl text-xl font-light ml-5">
    +91000000000
  </Link>
</div>
...
<div className="flex mt-5">
  ...
  <Link to="mailto:abccdefpvtltd@gmail.com" className="lg:text-2xl text-xl font-light ml-5">
    abc@gmail.com
  </Link>
</div>
